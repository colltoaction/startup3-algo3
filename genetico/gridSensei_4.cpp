...
//ENTRENADO SOLO CONTRA RANDOM
//    { 0.5, 0.25, 0, 0.75, -0.25, -0.75, 0.75, 0.75, 0.25, -0.25, 1, 1, 1, -0.5, 0 }
    
//    ENTRENADO CONTRA RANDOM Y GENETICO
//    {0.6,-0.4,-0.4,1,0.2,0.2,0.8,0.2,-2.98023e-08,-1,-0.2,-2.98023e-08,0.4,-0.2,-0.2}
    return Genome(4,
                { 0.5, 0.25, 0, 0.75, -0.25, -0.75, 0.75, 0.75, 0.25, -0.25, 1, 1, 1, -0.5, 0 }
    );
}
