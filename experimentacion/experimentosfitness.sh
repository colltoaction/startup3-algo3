...
do
	let SURVIVORS=${POPSIZE}/4
	./main_test.o 6 7 4 21 10 $POPSIZE 100 0.8f 0.05f 0.5f 1.0f 0.01f 1 0.0f 50 200 2> "../experimentacion/mediciones/fitness_pop${POPSIZE}.out"
done

for NSURVIVORS in {50..250..50}
do
	./main_test.o 6 7 4 21 ${NSURVIVORS} 250 10 0.8f 0.05f 0.5f 1.0f 0.01f 1 0.0f 50 200 2> "../experimentacion/mediciones/fitness_${NSURVIVORS}survivors.out"
done
...
RIVAL=RANDOM ./main_test 6 7 4 21 10 30 10 0.8f 0.05f 0.5f 1.0f 0.01f 1 0.0f 5 10